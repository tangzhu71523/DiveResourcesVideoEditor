...
class OverlayElement:
    ...
    def from_dict(cls, d: dict[str, Any] | None, *, default: "OverlayElement") -> "OverlayElement":
        ...
        align = str(d.get("align", default.align)).lower()
...
class JobMeta:
    ...
    cover_overlay: OverlayElement = field(default_factory=lambda: OverlayElement(
        ...
        align=_DEFAULT_COVER_OVERLAY.align,
    ))
    small_overlay: OverlayElement = field(default_factory=lambda: OverlayElement(
        ...
        align=_DEFAULT_SMALL_OVERLAY.align,
    ))
    ...
    # Optional quality filter. Default False preserves the stripped pipeline:
    # speech only, no aggressive VAD / hallucination / HSV visual pruning.
    filter_enabled: bool = False

    def to_dict(self) -> dict[str, Any]:
        d = asdict(self)
        if self.intro_speech_override is None:
            d.pop("intro_speech_override", None)
        else:
    ...
    def from_dict(cls, d: dict[str, Any]) -> "JobMeta":
        ...
        return cls(
            ...
            filter_enabled=bool(d.get("filter_enabled", False)),
        )
