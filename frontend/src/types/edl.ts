...
export interface Segment {
  ...
  lane_file?: string  // optional UI lane id when one source has variants
...
export interface SourceEDLSegment {
  file: string
  start: number
  end: number
  label?: string
...
export interface VideoFile {
  ...
  source_path?: string       // real media path when path is a virtual lane id
  duration_sec: number
  size_bytes: number
}
